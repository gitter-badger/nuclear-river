...
namespace NuClear.AdvancedSearch.EntityDataModel.Metadata.Tests
{
    ...
    internal class CustomerIntelligenceMetadataTests
    {
        ...
        [TestCase("CustomerIntelligence/ConceptualModel/FirmCategory", MetadataKind.Identity, Result = "{'Identity':{'Id':'erm://metadata/AdvancedSearch/CustomerIntelligence/ConceptualModel/FirmCategory'}}")]
        ...
        [TestCase("CustomerIntelligence/StoreModel/CustomerIntelligence.FirmCategory", MetadataKind.Identity, Result = "{'Identity':{'Id':'erm://metadata/AdvancedSearch/CustomerIntelligence/StoreModel/CustomerIntelligence.FirmCategory'}}")]
        ...
        [TestCase("CustomerIntelligence/StoreModel/CustomerIntelligence.FirmCategory/FirmId", MetadataKind.Identity | MetadataKind.Features, Result = "{'Identity':{'Id':'erm://metadata/AdvancedSearch/CustomerIntelligence/StoreModel/CustomerIntelligence.FirmCategory/FirmId'},'Features':[{'Cardinality':'One','Target':{'Identity':{'Id':'erm://metadata/AdvancedSearch/CustomerIntelligence/StoreModel/CustomerIntelligence.Firm'},'Features':[]}}]}")]
