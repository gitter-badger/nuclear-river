...
namespace NuClear.AdvancedSearch.EntityDataModel.Metadata.Tests
{
    ...
    internal class CustomerIntelligenceMetadataTests
    {
        ...
        [TestCase("CustomerIntelligence/ConceptualModel/Territory", MetadataKind.Identity | MetadataKind.Features, Result = "{'Identity':{'Id':'erm://metadata/AdvancedSearch/CustomerIntelligence/ConceptualModel/Territory'},'Features':[{'EntitySetName':'Territories'}]}")]
