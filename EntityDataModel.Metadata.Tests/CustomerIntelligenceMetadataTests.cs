...
namespace NuClear.AdvancedSearch.EntityDataModel.Metadata.Tests
{
    ...
    internal class CustomerIntelligenceMetadataTests
    {
        ...
        [TestCase("BusinessDirectory/ConceptualModel/Category", MetadataKind.Identity | MetadataKind.Features, Result = "{'Identity':{'Id':'erm://metadata/AdvancedSearch/BusinessDirectory/ConceptualModel/Category'},'Features':[{'EntitySetName':'Category'}]}")]
        [TestCase("BusinessDirectory/ConceptualModel/CategoryGroup", MetadataKind.Identity | MetadataKind.Features, Result = "{'Identity':{'Id':'erm://metadata/AdvancedSearch/BusinessDirectory/ConceptualModel/CategoryGroup'},'Features':[{'EntitySetName':'CategoryGroup'}]}")]
        [TestCase("BusinessDirectory/ConceptualModel/OrganizationUnit", MetadataKind.Identity | MetadataKind.Features, Result = "{'Identity':{'Id':'erm://metadata/AdvancedSearch/BusinessDirectory/ConceptualModel/OrganizationUnit'},'Features':[{'EntitySetName':'OrganizationUnit'}]}")]
        [TestCase("BusinessDirectory/ConceptualModel/Territory", MetadataKind.Identity | MetadataKind.Features, Result = "{'Identity':{'Id':'erm://metadata/AdvancedSearch/BusinessDirectory/ConceptualModel/Territory'},'Features':[{'EntitySetName':'Territory'}]}")]
        [TestCase("BusinessDirectory/ConceptualModel/Territory/OrganizationUnit", MetadataKind.Identity | MetadataKind.Features, Result = "{'Identity':{'Id':'erm://metadata/AdvancedSearch/BusinessDirectory/ConceptualModel/Territory/OrganizationUnit'},'Features':[{'Cardinality':'One','Target':{'Identity':{'Id':'erm://metadata/AdvancedSearch/BusinessDirectory/ConceptualModel/OrganizationUnit'},'Features':[{'EntitySetName':'OrganizationUnit'}]}}]}")]
