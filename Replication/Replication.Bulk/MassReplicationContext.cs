...
namespace NuClear.AdvancedSearch.Replication.Bulk
{
	...
	{
		public MassReplicationContext(Storage source, Storage target, HierarchyMetadata metadata, Func<IMetadataElement, IQuery, DataConnection, IMassProcessor> factory)
		{
			Source = source;
			Target = target;
