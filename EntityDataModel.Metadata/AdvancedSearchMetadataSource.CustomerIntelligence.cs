        ...
        private static readonly StructuralModelElementBuilder ConceptualModel =
            StructuralModelElement.Config.Elements(
                EntityElement.Config.Name(EntityName.Firm).EntitySetName("Firms")
                    ...
                    .Property(EntityPropertyElement.Config.Name("LastDisqualifiedOn").OfType(EntityPropertyType.DateTimeOffset))
                    .Property(EntityPropertyElement.Config.Name("LastDistributedOn").OfType(EntityPropertyType.DateTimeOffset))
