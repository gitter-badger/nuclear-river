...
namespace CustomerIntelligence.Replication.DataTest.Model
{
    ...
    {
        private static readonly ArrangeMetadataElement MinimalFirmAggregate
            = ArrangeMetadataElement.Config
                ...
                .Fact(
                    ...
                    new Facts::Category { Id = 1, Level = 1, Name = "Category level 1", ParentId = null },
                    new Facts::Category { Id = 2, Level = 2, Name = "Category level 2", ParentId = 1 },
                    new Facts::Category { Id = 3, Level = 3, Name = "Category level 3", ParentId = 2 },
                    new Facts::Category { Id = 4, Level = 3, Name = "Category level 3", ParentId = 2 },
                ...
                .Erm(
                    ...
                    new Erm::Category { Id = 1, Level = 1, ParentId = null, Name = "Category level 1", IsActive = true, IsDeleted = false },
                    new Erm::Category { Id = 2, Level = 2, ParentId = 1, Name = "Category level 2", IsActive = true, IsDeleted = false },
                    new Erm::Category { Id = 3, Level = 3, ParentId = 2, Name = "Category level 3", IsActive = true, IsDeleted = false },
                    new Erm::Category { Id = 4, Level = 3, ParentId = 2, Name = "Category level 3", IsActive = true, IsDeleted = false },
