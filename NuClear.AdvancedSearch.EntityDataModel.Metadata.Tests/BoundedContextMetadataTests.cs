...
namespace NuClear.EntityDataModel.Tests
{
    internal class BoundedContextMetadataTests
    {
        ...
        [TestCase("CustomerIntelligence/Firm/Id", "Identity,Features", Result = "{'Identity':{'Id':'erm://metadata/AdvancedSearch/CustomerIntelligence/Firm/Id'},'Features':[{'TypeCode':'Int64'}]}")]
        ...
        [TestCase("CustomerIntelligence/Firm/Categories/Id", "Identity,Features", Result = "{'Identity':{'Id':'erm://metadata/AdvancedSearch/CustomerIntelligence/Firm/Categories/Id'},'Features':[{'TypeCode':'Int64'}]}")]
        [TestCase("CustomerIntelligence/Firm/Categories/Name", "Identity,Features", Result = "{'Identity':{'Id':'erm://metadata/AdvancedSearch/CustomerIntelligence/Firm/Categories/Name'},'Features':[{'TypeCode':'String'}]}")]
        [TestCase("CustomerIntelligence/Firm/Categories/CategoryGroup", "Identity,Features", Result = "{'Identity':{'Id':'erm://metadata/AdvancedSearch/CustomerIntelligence/Firm/Categories/CategoryGroup'},'Features':[{'TypeCode':'Byte'}]}")]
